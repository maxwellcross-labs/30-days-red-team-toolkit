"""
Output utilities for Remote Execution Framework
...
class OutputHandler:
    ...
    def execution_header(self, method: str, target: str, username: str,
                         domain: str = ".", command: str = None):
        """Print execution attempt header"""
        self.info(f"{method} Remote Execution")
