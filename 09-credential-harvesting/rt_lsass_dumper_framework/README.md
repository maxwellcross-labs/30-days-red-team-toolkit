...
# Verify installation
python -c "import rt_lsass_dumper; print(lsass_dumper.__version__)"
```
...
```python
from rt_lsass_dumper import LsassDumper
...
```python
from rt_lsass_dumper.methods import ComsvcsDumper, ProcdumpDumper
...
```python
from rt_lsass_dumper.methods import ProcdumpDumper
