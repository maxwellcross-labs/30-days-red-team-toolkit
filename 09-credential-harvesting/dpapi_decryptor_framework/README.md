...
# Verify installation
python -c "import dpapi_decryptor; print(dpapi_decryptor.__version__)"
```
...
```python
from dpapi_decryptor import DPAPIDecryptor
...
```python
from dpapi_decryptor.utils import dpapi_decrypt, dpapi_decrypt_string
...
```python
from dpapi_decryptor.utils import is_dpapi_available
