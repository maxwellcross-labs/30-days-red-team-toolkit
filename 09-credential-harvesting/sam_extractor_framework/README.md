...
# Verify installation
python -c "import sam_extractor; print(sam_extractor.__version__)"
```
...
```python
from sam_extractor.methods import RegSaveExtractor, VSSExtractor
...
```python
from sam_extractor import SecretsdumpParser
...
```python
from sam_extractor.utils import validate_extracted_files
